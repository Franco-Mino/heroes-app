    ...
    return (
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
            <div className="relative h-64">
                ...
                {/* Universe*/}
                {
                    hero.universe.toLowerCase() === 'marvel' ? (
            ...
            <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-[-10px] transition-all duration-300">                <div className="flex justify-between items-start">
            ...
            <CardContent className="space-y-4">
                ...
                {/* Stats: Inelligence, Speed, Durability, Strength */}
