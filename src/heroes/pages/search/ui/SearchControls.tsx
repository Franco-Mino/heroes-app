...
export const SearchControls = () => {
    ...
    const ACCORDION_ID = 'advance-filters';
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button
                        variant={activeAccordion === ACCORDION_ID ? 'default' : 'outline'}
                        className="h-12 "
                        onClick={() => {
                            setQueryParams(
                                'active-accordion',
                                activeAccordion === ACCORDION_ID ? '' : ACCORDION_ID
                            )
                        }}
                    >
            ...
            <Accordion type="single" collapsible value={activeAccordion}>
                <AccordionItem value={ACCORDION_ID}>
                        ...
                        <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
                            ...
                            <div className="mt-4" >
                                <label className="text-sm font-medium ">
                                    minium Strenght: {selectedStrenght}/10
                                </label>
                                <Slider
